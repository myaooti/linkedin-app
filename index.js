...
app.controller('AuthController', function($scope, $state) {
    $scope.authorize = function() {
        //window.location.href = "https://www.linkedin.com/uas/oauth2/authorization?response_type=code&client_id=77xkk5q1ej3v6z&redirect_uri=http://localhost:8000/oauth-callback&state=DCEeFWf45A53sdfKef424"
...
app.controller('OAuthCallbackController', function($scope, $location, $http) {
    ...
    if (queryParams.code) {
        ...
        var data = {
            ...
            "client_id": "77xkk5q1ej3v6z",
            "client_secret": "F0ukmRxoSWIbIt6D"
        };

        /*var url = "https://www.linkedin.com/uas/oauth2/accessToken?grant_type=authorization_code&code=" + $scope.code + "&redirect_uri=http://localhost:8000/oauth-callback&client_id=77xkk5q1ej3v6z&client_secret=F0ukmRxoSWIbIt6D";
        $http.get(url).then(function(response) {
            console.log(response);
        });*/
        
        //window.location.href = "https://www.linkedin.com/uas/oauth2/accessToken?grant_type=authorization_code&code=" + $scope.code + "&redirect_uri=http://localhost:8000/oauth-callback&client_id=77xkk5q1ej3v6z&client_secret=F0ukmRxoSWIbIt6D";
